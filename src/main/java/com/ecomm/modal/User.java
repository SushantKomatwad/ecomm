...
public class User {
	...
	private List<PaymentInformation> paymentInformatation=new ArrayList<>();  
	...
	public User(Long id, String firstName, String lastName, String password, String email, String role, String mobile,
			List<Address> address, List<PaymentInformation> paymentInformatation, List<Rating> ratings,
		...
		this.paymentInformatation = paymentInformatation;
	...
	public List<PaymentInformation> getPaymentInformatation() {
		return paymentInformatation;
	}

	public void setPaymentInformatation(List<PaymentInformation> paymentInformatation) {
		this.paymentInformatation = paymentInformatation;
	}
